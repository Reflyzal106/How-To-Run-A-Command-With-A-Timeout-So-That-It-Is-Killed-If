# [SOLVED] How-To-Run-A-Command-With-A-Timeout-So-That-It-Is-Killed-If
...
>
> ### ➡️ [CLICK HERE TO VIEW THE FULL FIX GUIDE](https://techfixdocs.my.id/how-to-run-a-command-with-a-timeout-so-that-it-is-killed-if)
>
...
Use `timeout` command to run a command with a timeout, e.g. `timeout 5m /path/to/slow/command`
...
👉 **[Go to ErrorFix Hub Full Article](https://techfixdocs.my.id/how-to-run-a-command-with-a-timeout-so-that-it-is-killed-if)**
